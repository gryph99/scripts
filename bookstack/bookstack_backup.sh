...
tar -czvf bookstack-backup.tar.gz bookstack-files-backup.tar.gz kb.alexthompson.tech.backup.sql 

# Clean up uneeded files.
rm bookstack-files-backup.tar.gz kb.alexthompson.tech.backup.sql
